...
(cd ../../writer/ && cargo run --bin writer) | (cargo run --bin tierCountMerging "count" "4" "3" "9C3")
...
#(cd ../../writer/ && cargo run --bin writer) | (cargo run --bin tierCountMerging -- "interval" "1S" "7S" "20SC2"  )
